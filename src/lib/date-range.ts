...
export type PeriodoPreset = "hoje" | "7dias" | "30dias" | "mes_atual" | "personalizado";
...
export const PERIODO_OPCOES: PeriodoPreset[] = ["hoje", "7dias", "30dias", "mes_atual", "personalizado"];
